...
# reading shot data
df = pd.read_csv('rma_esp.csv',encoding='iso-8859-1')
...
rma_url = 'https://upload.wikimedia.org/wikipedia/sq/c/cc/428px-Logo_Real_Madrid.svg.png'
rma_logo = Image.open(urlopen(rma_url))

esp_url = 'https://upload.wikimedia.org/wikipedia/commons/2/29/Rcd_espanyol_logo.png'
esp_logo = Image.open(urlopen(esp_url))


txt1 = axs['pitch'].text(x=25, y=8, s='Real Madrid Shots & Goal', fontproperties=fm.prop, color='maroon',
